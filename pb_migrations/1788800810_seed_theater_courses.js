...
migrate((app) => {
  ...
  "teachers": [
    ...
    },
    {
      ...
      "bio_ru": "Участник продюсерского объединения WE ARE CENTRAL ASIA и Международного фестиваля анимационных фильмов TIAF.",
      "bio_en": "Member of the WE ARE CENTRAL ASIA production collective and the TIAF International Animation Film Festival.",
      "bio_uz": "WE ARE CENTRAL ASIA prodyuserlik birlashmasi va TIAF xalqaro animatsion filmlar festivali ishtirokchisi."
    },
    {
      "id": "courseteacher03",
    ...
    },
    {
      ...
      "bio_ru": "Лектор с международным опытом, который поможет освоить основы поэтического мастерства и научиться уверенно выражать свои мысли через творчество.",
      "bio_en": "A lecturer with international experience who helps students learn the craft of poetry and express their thoughts confidently through creative work.",
      "bio_uz": "Xalqaro tajribaga ega ma’ruzachi. She’riyat mahorati asoslarini o‘rganishga va ijod orqali fikrlarni ishonch bilan ifodalashga yordam beradi."
    }
  ],
  "courses": [
    {
    ...
    },
    {
      ...
      "summary_en": "Paper becomes scenery. Objects become actors. Make a film of your own, from the first idea to the premiere.",
      "summary_uz": "Qog‘oz — dekoratsiya. Buyumlar — aktyorlar. Ilk g‘oyadan premyeragacha o‘z filmingizni yarating.",
      ...
      "sections": [
        ...
        },
        {
          ...
          "body_ru": "Интенсив рассчитан на 16 практических занятий: 8 занятий в месяц по 2 часа. Программа представляет собой полный цикл кинопроизводства — от идеи до премьеры.",
          "body_en": "16 practical classes, with eight two-hour sessions each month. The programme follows the complete filmmaking process, from an idea to its premiere.",
          "body_uz": "16 ta amaliy mashg‘ulot: oyiga 8 marta, 2 soatdan. Dastur kino yaratishning to‘liq jarayonini — g‘oyadan premyeragacha — qamrab oladi.",
          "items_ru": "",
          "items_en": "",
          "items_uz": ""
        }
    ...
    },
    {
      ...
      "enrollment_note_ru": "Набор временно закрыт. Свяжитесь с нами, чтобы узнать о следующей группе и листе ожидания.",
      ...
      "summary_ru": "Ясно выражать мысли, удерживать внимание и находить слова без подготовки. Практика для бизнеса и повседневного общения.",
      "summary_en": "Express ideas clearly, hold an audience’s attention and find your words without a script. Practice for business and everyday life.",
      "summary_uz": "Fikrni aniq ifodalash, tinglovchi e’tiborini ushlash va tayyorgarliksiz so‘z topish. Biznes va kundalik muloqot uchun amaliyot.",
      ...
      "sections": [
        ...
        },
        {
          ...
          "body_ru": "Фундамент эффективной речи начинается с правильной базы. В этом блоке вы освоите постановку речи, научитесь работать с дыханием и голосом, улучшите дикцию и научитесь логично выстраивать свои мысли, чтобы говорить понятно, последовательно и уверенно.\n\n\n\nИзучаемые темы:\nпостановка речи;\nдыхание и голос;\nразвитие дикции;\nструктура и логика мысли.",
          "body_en": "Develop speech, breath, voice and diction. Learn to organise thoughts logically and speak clearly and consistently.",
          "body_uz": "Nutq, nafas, ovoz va diksiyani rivojlantirish. Fikrlarni mantiqan tuzish, aniq va izchil gapirish.",
          "items_ru": "",
          "items_en": "",
          "items_uz": ""
        },
        {
          ...
          "body_ru": "Этот блок посвящен развитию внутренней уверенности и навыков выступления перед аудиторией. Вы научитесь справляться со страхом сцены и волнением, использовать язык тела как инструмент влияния и устанавливать контакт с аудиторией.\n\n\n\nПрактические упражнения:\n«Одна мысль — одна минута»;\n«Говори без пауз»;\n«Объясни сложное простым языком»;\nвыход на сцену;\nимпровизированные выступления;\nудержание внимания аудитории.",
          "body_en": "Work with stage fright, body language and audience connection. Exercises include “One thought, one minute”, speaking without pauses, explaining complex ideas simply, stage practice, improvised speeches and holding attention.",
          "body_uz": "Sahna qo‘rquvi, tana tili va auditoriya bilan aloqa ustida ishlash. Mashqlar: “Bir fikr — bir daqiqa”, pauzasiz gapirish, murakkab fikrni sodda tushuntirish, sahnaga chiqish, improvizatsion nutq va e’tiborni ushlash.",
          "items_ru": "",
          "items_en": "",
          "items_uz": ""
        },
        {
          ...
          "body_ru": "Главная особенность курса — развитие способности быстро мыслить и уверенно говорить без подготовки. Именно здесь формируются навыки, которые помогают чувствовать себя уверенно в переговорах, интервью, деловых встречах и любых непредвиденных ситуациях.\n\n\n\nВ программе:\nдебаты;\nупражнение «Адвокаты и прокуроры»;\nзащита собственной позиции;\n«Продай идею за одну минуту»;\nимпровизация без подготовки;\nкомандные упражнения «Собери команду»\n\nПрактика направлена на развитие:\nскорости мышления;\nчеткости речи;\nгибкости мышления;\nуверенности в любой коммуникации.",
          "body_en": "Think quickly and speak without preparation in negotiations, interviews and unexpected situations. Practise debates, “Advocates and prosecutors”, defending a position, “Sell an idea in one minute”, impromptu speaking and “Build a team”. Develop speed, clarity, flexible thinking and confidence.",
          "body_uz": "Muzokara, suhbat va kutilmagan vaziyatlarda tez fikrlash va tayyorgarliksiz gapirish. Debatlar, “Advokatlar va prokurorlar”, o‘z fikrini himoya qilish, “G‘oyani bir daqiqada sot”, improvizatsiya va “Jamoa tuz” mashqlari. Fikrlash tezligi, nutq aniqligi, moslashuvchanlik va ishonchni rivojlantirish.",
          "items_ru": "",
          "items_en": "",
          "items_uz": ""
        },
        {
          ...
          "body_ru": "Заключительный блок посвящен искусству убеждения и ведения переговоров. Вы освоите методы аргументации, научитесь управлять диалогом, работать с возражениями и сохранять сильную позицию даже в сложных переговорах.\n\n\n\nПрактика включает:\nпереговорные сценарии;\nразбор конфликтных ситуаций;\nработу в условиях давления;\nтехники защиты своей позиции.",
          "body_en": "Learn argumentation, guide a conversation, work with objections and hold your position in difficult negotiations. Practise negotiation scenarios, conflict analysis, working under pressure and defending your position.",
          "body_uz": "Dalillash, suhbatni boshqarish, e’tirozlar bilan ishlash va murakkab muzokarada o‘z pozitsiyasini saqlash. Muzokara ssenariylari, nizoli vaziyatlar tahlili, bosim ostida ishlash va o‘z pozitsiyasini himoya qilish mashqlari.",
          "items_ru": "",
          "items_en": "",
          "items_uz": ""
        },
    ...
    },
    {
      ...
      "summary_ru": "Найдите собственный голос. От первых строк до выразительного чтения перед слушателями — с поддержкой и обратной связью.",
      "summary_en": "Find your own voice. From your first lines to reading aloud, with encouragement and thoughtful feedback.",
      "summary_uz": "O‘z ovozingizni toping. Ilk satrlardan tinglovchi oldida ifodali o‘qishgacha — ko‘mak va fikr-mulohaza bilan.",
      ...
      "description_ru": "Поэзия — это гораздо больше, чем рифмы и красивые строки. Это способ услышать себя, разобраться в своих чувствах и превратить эмоции в искусство.\n\nКурс поэзии — это пространство для творчества, самовыражения и личного роста.",
      "description_en": "Poetry is more than rhyme and beautiful lines. It is a way to listen to yourself, understand your feelings and turn emotion into art.\n\nThe course offers space for creativity, self-expression and personal growth.",
      "description_uz": "She’riyat qofiya va chiroyli satrlardan ko‘proq narsadir. U o‘zingizni tinglash, hislarni tushunish va tuyg‘ularni san’atga aylantirish usuli.\n\nKurs ijod, o‘zini ifodalash va shaxsiy o‘sish uchun makon.",
  ...
  for (const item of seed.courses) {
    ...
    sections.forEach((section, index) => saveNew('t_course_section', {
      ...section, id: `cs${course.sort_order}${String(index + 1).padStart(11, '0')}`, course: course.id, sort_order: (index + 1) * 10,
    }))
  }
}, () => {
