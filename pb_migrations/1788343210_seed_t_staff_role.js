  ...
  (app) => {
    ...
    const roles = [
      ...
      { id: '003d076cf3824a6', name_en: 'Robot', name_ru: 'Робот', name_uz: 'Robot', type: 'actor' },
      {
        id: '8c738b655ef7673',
        name_en: 'Song Doll',
        name_ru: 'Кукла Песенка',
        name_uz: 'Pesenka qo‘g‘irchog‘i',
        type: 'actor',
      },
      {
        id: 'b4d2ddffd64a5ce',
        name_en: 'Strunka Doll',
        name_ru: 'Кукла Струнка',
        name_uz: 'Strunka qo‘g‘irchog‘i',
        type: 'actor',
      },
      {
        id: '8c229dc1518e42a',
        name_en: 'Domisol Doll',
        name_ru: 'Кукла Домисоль',
        name_uz: 'Domisolka qo‘g‘irchog‘i',
        type: 'actor',
      },
      ...
      { id: 'cdf9187471348ea', name_en: 'Painter', name_ru: 'Художник', name_uz: 'Rassom', type: 'actor' },
      {
        ...
        name_uz: 'Qizil bo‘yoq',
        type: 'actor',
      },
      {
        id: '10608f5a6ee325b',
        name_en: 'Green Paint',
        name_ru: 'Зелёная краска',
        name_uz: 'Yashil bo‘yoq',
        type: 'actor',
      },
      {
        id: '41db3e8db1a3ba4',
        name_en: 'Black Paint',
        name_ru: 'Чёрная краска',
        name_uz: 'Qora bo‘yoq',
        type: 'actor',
      },
      {
        id: 'f48dfb108691f69',
        name_en: 'Yellow Paint',
        name_ru: 'Жёлтая краска',
        name_uz: 'Sariq bo‘yoq',
        type: 'actor',
      },
      ...
      {
        id: '820d43af357ecc5',
        name_en: 'Sea Dwellers',
        name_ru: 'Обитатели моря',
        name_uz: 'Dengiz aholisi',
        type: 'actor',
      },
    ]
    const staffRoles = [
