...
migrate(
  (app) => {
    const translated = (name, max, help) =>
      ['ru', 'en', 'uz'].map((locale) => ({ type: 'text', name: `${name}_${locale}`, max, help }))
    const dates = [
      ...
      fields: [
        {
          ...
          maxSelect: 1,
          cascadeDelete: false,
          help: 'Link an existing team member to reuse their name, portrait and public profile. Leave empty for a guest teacher.',
        },
      ...
      fields: [
        {
          type: 'bool',
          name: 'published',
          help: 'Only published courses and their sections are public. Rebuild the website after editing.',
        },
        {
          type: 'text',
          name: 'slug',
          ...
          help: 'Generated once from the title. Preserved by the theater slug hook.',
        },
        { type: 'number', name: 'sort_order', min: 0, onlyInt: true },
        {
          ...
          required: true,
          maxSelect: 1,
          values: ['enquire', 'open', 'waitlist', 'closed'],
          help: 'enquire: ask for dates; open: enrollment confirmed; waitlist: intake closed but enquiries welcome; closed: no enrollment action.',
        },
        ...
        ...translated(
          'cover_alt',
          500,
          'Describe the cover photo. Leave empty if the adjacent title already describes it.',
        ),
        ...
        { type: 'number', name: 'session_minutes', min: 0, onlyInt: true },
        {
          ...
          name: 'price_uzs',
          min: 0,
          help: 'Confirmed amount in UZS. Zero/empty means ask for price, never free.',
        },
        {
          type: 'text',
          name: 'contact_phone',
          max: 30,
          pattern: '^\\+?[0-9 ()-]*$',
          help: 'Public enrollment phone number, with country code.',
        },
        {
          type: 'url',
          name: 'enrollment_url',
          help: 'Optional real booking or contact destination. Otherwise the phone number is used.',
        },
        {
          type: 'file',
          name: 'cover',
        ...
        },
        {
          ...
          maxSelect: 20,
          cascadeDelete: false,
          help: 'Select teachers in display order. Guest teachers and linked theater staff are both supported.',
        },
    ...
    const sections = new Collection({
      name: 't_course_section',
      type: 'base',
      listRule: 'course.published = true',
      viewRule: 'course.published = true',
      createRule: null,
      updateRule: null,
      deleteRule: null,
      fields: [
        ...
        },
        {
          ...
          required: true,
          maxSelect: 1,
          values: ['about', 'audience', 'outcomes', 'program', 'format', 'faq'],
          help: 'Program and FAQ render as expandable sections; other kinds remain visible.',
        },
        { type: 'number', name: 'sort_order', min: 0, onlyInt: true },
    ...
    media.fields.add(
      new RelationField({
        ...
        maxSelect: 100,
        cascadeDelete: false,
        help: 'Courses shown in this photo. Upload once, then tag relevant courses and people.',
      }),
    )
    app.save(media)
  },
