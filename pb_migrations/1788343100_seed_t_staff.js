...
migrate((app) => {
  ...
  },
  {
    ...
    description_en: "“Ded Moroz’s Chest” — New Year’s Ornament Pine Cone and Little Cook.\n“Colors” — Green Paint.\n“Toy Workshop ” — Doll Domisolka .",
    description_ru: "«Сундук Деда Мороза» — Новогодняя игрушка Шишечка и Поварëнок\n«Краски» — Зелёная краска\n«Мастерская игрушек» — кукла Домисолька",
    description_uz: "“Qorbobo sandig‘i” – Yangi yil o‘yinchog‘i Shishacha vaOshpazcha.\n“Bo‘yoqlar” – Yashil bo‘yoq.\n“O‘yinchoqlar ustaxonasi” – Domisolka qo‘g‘irchog‘i.",
    quote_en: "“Start by doing what is necessary. Then do what is possible. And suddenly you will find yourself doing the impossible.”",
    quote_ru: "«Начинайте делать то, что нужно. Затем делайте то, что возможно. И ы внезапно обнаружите, что делаете невозможное»",
    quote_uz: "Avval qilinishi kerak bo‘lgan ishni boshlang. Keyin imkoningiz yetganini qiling. Bir kun kelib esa, o‘zingizni imkonsizdek tuyulgan ishni bajarayotganingizni ko‘rasiz."
  },
  {
    id: "d23919f619e4d76",
    gender: "female",
  ...
  },
  {
    ...
    education_en: "Higher School of Olympic Reserve (RSDYuSShOR) in Rhythmic Gymnastics\nMaster of Sports in Rhythmic Gymnastics",
    education_ru: "Высшая школа олимпийского резерва (РСДЮСШОР) по художественной гимнастике.\nМастер спорта по художественной гимнастике.",
    education_uz: "Badiiy gimnastika bo‘yicha Olimpiya zaxiralari oliy maktabi(RIBO‘ZSM).\nBadiiy gimnastika bo‘yicha sport ustasi.",
    ...
    quote_uz: "Butun hayotingizni o‘zgartirishga urinmang. Hayotga bo‘lgan munosabatingizni o‘zgartirishning o‘zi kifoya."
  },
  {
    id: "1998053eeda2fb3",
    gender: "female",
  ...
  },
  {
    ...
    name_ru: "Попова Яна",
    name_uz: "Popova Yana",
    education_en: "Merzhanov College at the S. V. Rachmaninoff Tambov State Musical Pedagogical Institute, majoring in Choral Conducting (Tambov, Russia)\nG. R. Derzhavin Tambov State University, majoring in Theatre and Film Acting (Tambov, Russia)",
    education_ru: "Колледж В.К. Мержанова при ТГМПИ им. С.В. Рахманинова по специальности дирижер академическим хором (Россия, г. Тамбов).\nТГУ им. Г.Р. Державина по специальности «Актриса театра и кино» (Россия, г. Тамбов).",
    education_uz: "S. V. Raxmaninov nomidagi TВMPI huzuridagi V. K. Merjanovkolleji. Mutaxassisligi – akademik xor dirijyori (Tambov, Rossiya).\nG. R. Derjavin nomidagi TDU. Mutaxassisligi – teatr va kino aktrisasi (Tambov, Rossiya).",
  ...
  },
  {
    ...
    education_en: "S. A. Gerasimov All-Russian State Institute of Cinematography (VGIK)\nWorkshop of Rustam Abdullaevich Sagdullaev",
    education_ru: "Всероссийский государственный институт кинематографии имени С.А.Герасимова — мастерская Сагдуллаева Рустама Абдуллаевича",
    education_uz: "S. A. Gerasimov nomidagi Butunrossiya davlat kinematografiyainstituti (BDKU), Rustam Abdullayevich Sagdullayevustaxonasi.",
    description_en: "“Colours” — Green Paint / Black Paint\n“Toy Workshop” — Teddy Bear\nGraduation performances:\nKing Lear by William Shakespeare — Regan\nBalzaminov’s Marriage by Alexander Ostrovsky — Matryona\nCount Nulin by Alexander Pushkin — Natalya Pavlovna",
    description_ru: "«Краски» — Зеленая/Черная краска\n«Мастерская игрушек» — Мишка\nДипломные спектакли:\n«Король Лир» — Шекспир -роль — Регана\n«Женитьба Бальзаминова» — Островский -роль — Матрена\n«Граф Нулин» — Наталья Павловна",
    description_uz: "“Bo‘yoqlar” – Yashil bo‘yoq / Qora bo‘yoq.\n“O‘yinchoqlar ustaxonasi” – Ayiqcha.\nDiplom spektakllari:\n“Qirol Lir” (Uilyam Shekspir) – Regana.\n“Balzaminovning uylanishi” (Aleksandr Ostrovskiy) – Matryona.\n“Graf Nulin” – Natalya Pavlovna.",
    quote_en: "“I cry out: I feel, I suffer, I am happy, I am excited. Only my own mystery interests me. Above all, I seek myself within my great emptiness.”",
    quote_ru: "«Я кричу: я чувствую, я страдаю, я счастлива, я взволнована. Только моя загадка интересует меня. Больше всего я ищу себя в своей великой пустоте»",
    quote_uz: "Va men hayqiraman: men his etaman, men azob chekaman, men baxtliman, men hayajondaman. Meni faqat o‘zimning sirim qiziqtiradi. Eng ko‘p esa buyuk bo‘shlig‘im ichida o‘zimni izlayman."
  },
  {
    id: "e946351f9238991",
    gender: "female",
  ...
  },
  {
    ...
    description_ru: "«Краски» — Лягушка, Листочек, Лучик, Рыба\n«Мастерская игрушек» — Робот\n«Сундук Деда Мороза» — Левое Ухо",
    description_uz: "“Bo‘yoqlar” – Qurbaqa, Bargcha, Quyosh nuri va Baliq.\n“O‘yinchoqlar ustaxonasi” – Robot.\n“Qorbobo sandig‘i” – Chap quloq",
    quote_en: "To those who can hear me, I say: do not despair. We shall overcome this cruelty, the greed and hatred of those who stand in the way of human progress. Hatred will pass, dictators will die, and the power they took from the people will return to the people. And so long as men die, liberty will never perish…",
    quote_ru: "Тем, кто меня слышит, я говорю: «Не впадайте в отчаяние». Мы преодолеем эту жестокость, жадность и злость тех, кто препятствует человеческому прогрессу: ненависть пройдет, диктаторы умрут, а власть, которую они отобрали у людей, вернется к людям, и пока люди умирают, свобода никогда не умрет . . .",
    quote_uz: "Meni eshitayotganlarga shuni aytaman: “umidsizlikka tushmang”. Biz insoniyat taraqqiyotiga to‘sqinlik qilayotgan shafqatsizlik, ochko‘zlik va nafratni yengamiz. Nafrat yo‘qoladi, zolimlar ketadi, odamlardan tortib olingan hokimiyat yana odamlarga qaytadi. Insonlar o‘lar ekan, erkinlik abadiy yashaydi…"
  }
  ]
